...
import { View, Text,
     ScrollView, TouchableWithoutFeedback, Dimensions, ImageBackground, Share } from 'react-native';
...
const images = [require('../assets/leather.jpg'), 
require('../assets/beige.jpg'), require('../assets/polyester.jpeg'), require('../assets/stock.jpg')];
...
class SnapCarousel extends Component {
    ...
    render() {       
        ...
        return (
                <View ref="topView" style={{ flex: 1, justifyContent: 'center', paddingTop: 40, maxHeight: 400 }} collapsable={false}>
                    <Carousel 
                        ref="carousel"
